	...
	factory: (require) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [status?.debugPort === void 0 ? "" : `${copy("endpoint")} 127.0.0.1:${status.debugPort} · `, status?.url ?? ""]
		...
		*/
		function BrowserSettingsSection(props) {
			...
			const snapshot = (0, react.useSyncExternalStore)(subscribe, () => scope.getSnapshot());
